        ...
        <nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom">
            <div class="container">
                <a class="navbar-brand mr-lg-5" href="./index.html">
                    <img src="/assets/img/brand/volant courier.png" alt="logo here" height="auto" width="auto">
                </a>
                    ...
                    <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown" href="#" role="button">
                                ...
                                <span class="nav-link-inner--text">Click Parcel</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-xl">
                                <div class="dropdown-menu-inner">
                                    <a href="/packages" class="media d-flex align-items-center">
                                        <div class="icon icon-shape bg-gradient-default rounded-circle text-white">
                                            <i class="ni ni-building"></i>
                                        </div>
                                        <div class="media-body ml-3">
                                            <h6 class="heading text-darker mb-md-1">Volant Metro Package</h6>
                                    ...
                                    <a href="/packages" class="media d-flex align-items-center">
                                        ...
                                        <div class="media-body ml-3">
                                            <h6 class="heading text-dark mb-md-1">Volant Upcountry Package</h6>
                                    ...
                                    <a href="/packages" class="media d-flex align-items-center">
                                        ...
                                        <div class="media-body ml-3">
                                            <h5 class="heading text-default mb-md-1">Volant Special Package</h5>
